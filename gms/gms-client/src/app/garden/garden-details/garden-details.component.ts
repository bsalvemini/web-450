...
@Component({
  ...
  <div class="garden-details-page">
    <h1 class="garden-details-page__title">Garden Name</h1>
    ...
    <div class="garden-details-page__card">
      <form class="garden-details-page__form" [formGroup]="gardenForm">
        <div class="garden-details-page__form-group">
          <label for="name" class="garden-details-page__form-group">Garden Name</label>
          <input type="text" id="name" class="garden-details-page__form-control" formControlName="name">
        </div>
        <div class="garden-details-page__form-group">
          <label for="location" class="garden-details-page__form-group">Garden Location</label>
          <input type="text" id="location" class="garden-details-page__form-control" formControlName="location">
        </div>
        <div class="garden-details-page__form-group">
          <label for="description" class="garden-details-page__form-group">Garden Description</label>
