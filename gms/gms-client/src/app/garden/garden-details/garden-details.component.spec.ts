...
describe('GardenDetailsComponent', () => {
  ...
  it('should call updateGarden and navigate on successful form submission', fakeAsync(() => {
    ...
    expect(gardenService.updateGarden).toHaveBeenCalledWith(updateGardenDTO,
 component.gardenId);
  ...
  it('should handle error on form submission failure', fakeAsync(() => {
    ...
    expect(console.error).toHaveBeenCalledWith('Error updating garden', 'Error updating garden');
  }));
});
