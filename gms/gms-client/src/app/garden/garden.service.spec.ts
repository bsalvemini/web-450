...
describe('GardenService', () => {
  ...
  it('should add a new garden', () => {
    const AddGardenDTO: AddGardenDTO = { name: 'New Garden', location: 'Location 3', description: 'Description 3' };
    const newGarden: Garden = { _id: '3', gardenId: 3, name: 'New Garden', location: 'Location 3', description: 'Description 3' };
