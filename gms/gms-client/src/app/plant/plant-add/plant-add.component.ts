    ...
    <div class="plant-add-page__card">
      <form [formGroup]="plantForm" class="plant-add-page__form">
        <div class="plant-add-page__form-group">
          ...
          <input type="text" name="name" class="plant-add-page__form-control" formControlName="name">
        </div>
        <div class="plant-add-page__form-group">
        ...
        <div class="plant-add-page__form-group">
          ...
          <select name="" id="status" class="plant-add-page__form-control" formControlName="status">
        ...
        <input type="date" name="" id="datePlanted" class="plant-add-page__form-control" formControlName="datePlanted">
        </div>
        <button type="submit" (click)="onSubmit()" class="plant-add-page__btn">Add Plant</button>
      </form>
      <br />
      <a class="plant-add-page__link" routerLink="/plants"></a>
    </div>
  </div>
  `,
  styles: `
...
export class PlantAddComponent {
  ...
  constructor(private fb: FormBuilder, private router: Router, private plantService: PlantService, private gardenService: GardenService) {
