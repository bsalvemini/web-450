...
@Component({
  ...
  <div class="plant-details-page">
    ...
    <h4 class="plant-details-page__subtitle">Explore the detailed information about your selected plant, including its type and status.</h4>
    ...
    <div class="plant-details-page__card">
      <form [formGroup]="plantForm" class="plant-details-page__form">
        ...
        <div class="plant-details-page__form-group">
          ...
          <select name="" id="status" class="plant-details-page__form-control" formControlName="status">
...
export class PlantDetailsComponent {
  ...
  constructor (private fb: FormBuilder, private route: ActivatedRoute, private router: Router, private plantService: PlantService) {
  ...
  onSubmit() {
    if (this.plantForm.valid) {
      ...
      this.plantService.updatePlant(this.plantId, updatePlantDTO).subscribe({
        next: (result: any) => {
          console.log(`PlantId: ${this.plantId} ${result.message}`);
